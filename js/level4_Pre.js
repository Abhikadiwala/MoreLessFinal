...
document.addEventListener("visibilitychange", function () {
  ...
  if (pageHidden == false) {
    ...
    if (musicImgStatus == true) {
      ...
      // Start From first after come on page
      // ------------------------------------------------------------------------------------------------
      soundBG(BGSound)
      if (audioPlayed == true) {
        // checkBGAudio()
...
function playAudio(path) {
  ...
  if (isAudioPlaying) {
    ...
    audioLoader.load(path, function (buffer) {
      ...
      // // Stop click if audio 4 is working
      // switch (path) {
      //   case Audio4:
      //     console.log("Switch Audio4 work")
      //     // if (planeWrongAnsS2.visible == true) {
      //     //   planeWrongAnsS2.visible = false
      //     // }
...
function tryAgainSoundFunc(path) {
  ...
  audioLoader3.load(path, function (buffer) {
    ...
    // sound2.setVolume(0.1)
    // console.log("sound:- ", sound);
    // storeAudioState = sound3.source.onended;
  }, false);
}
  ...
  hBack.load(
    ...
    function (textureBack) {
      ...
      domEvents.addEventListener(planeBack, 'click', function (event) {
        ...
        sessionStorage.setItem('backBtnClick', 41) // 41 --> Level4 Presentation 
      ...
      if (AnsS3Cor == false) {
        ...
        domEventsInnerLHS.addEventListener(planeS3LHS, 'click', function (event) {
          if (AnsS3Cor == false) {
            ...
            // domEventsInnerLHS.removeEventListener(planeS3LHS, 'click', false) // active
        ...
        domEvents.addEventListener(planeS6LHS, 'click', function (event) {
          if (AnsS6Cor == false) {
            ...
            if (planeRedStatus == true) {
              ...
              // playAudio(tryAgainSound)
              // soundBG(tryAgainSound)
              // replyAudio(tryAgainSound)
