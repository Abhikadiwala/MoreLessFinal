...
var isReplayAudioPlay = true, isReplyBtnClick = false
...
function soundReplyAudio(path) {
  ...
  // isReplayAudioPlay status
  // isReplayAudioPlay = true
  ...
  hBack.load(
    ...
    function (textureBack) {
      ...
      domEvents.addEventListener(planeBack, 'click', function (event) {
        ...
        sessionStorage.setItem('backBtnClick', 3)
...
function l3Slide2() {
  ...
  // if (replyAudioBtnSound.isPlaying == true) {
  // alert(`${isReplyBtnClick}`)
  if (isReplyBtnClick == true) {
  ...
  loadSkipbtn.load(
    ...
    function (textureSkipBtn) {
      ...
      domEvents.addEventListener(planeSkipBtn, 'click', function (event) {
        ...
        // // sessionStorage.setItem('previous_Level', PageUrl)
        // localStorage.setItem('previous_Level', PageUrl)
        ...
        // store skip click in session
        sessionStorage.setItem('skipClick', 3)
        ...
        if (level4_Pre_val == false) {
          ...
          // window.location.replace(`/level4_Pre.html`); // working
          window.location.replace(`skipBtnPage.html`); // Testing

        } else {
          // document.location.href = '/level2.html'
          // window.location.replace(`/level4.html`); // working
          window.location.replace(`skipBtnPage.html`); // Testing
...
function levelThreeComplete() {
  ...
  LevelCompleteSound(Audio_GL_A_5)
