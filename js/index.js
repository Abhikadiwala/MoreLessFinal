...
localStorage.clear()   // -- Uncomment if always want fresh start
// -----------------------------------------------------------------------------------
...
var setLevelStart = localStorage.setItem('levelStart', false); // for level starting status
var setLevelStart = localStorage.setItem('BGSound', true); // Backgroud Sound Default true
...
if (level0Final == true) {
  console.log("redirect Level 0");
  // location.href = "index.html" // Working
