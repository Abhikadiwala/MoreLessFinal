...
var S1LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 1_10 red shirts.png"   // 10 Red Shirts
var S1RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 1_2 red shirts.png"   // 2 Red Shirts
...
// Slide-3 Images
var S3LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 3_8 chairs.png"   // 8 chair
var S3RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 3_2 chairs.png"   // 2 chair

// Slide-4 Images
var S4LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 4_8 blue footballs.png"  // 8 FootBalls Blue
var S4RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 4_4 blue footballs.png"  // 4 FootBalls Blue
...
// Slide-7 Images
var S7LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 7_8 socks.png"  // 8 socks
var S7RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 7_6 socks.png"  // 6 socks
...
// Slide-9 Images
var S9LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 9_5 white footballs.png"  // 5 white ball
var S9RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 9_4 white footballs.png"  // 4 white ball

// Slide-10 Images
var S10LHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 10_10 shoes.png"  // 10 Shoes
var S10RHS = "../asset/level_two_assets/image asset Ltwo Updated/Set 10_9 shoes.png"  // 9 Shoes
...
function headerBack() {
  ...
  hBack.load(
    ...
    function (textureBack) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometryBack = new THREE.PlaneBufferGeometry(0.38, 0.38);
...
function headerProgress(PIpath) {
  ...
  hProgress.load(
    ...
    function (textureProgress) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometryProgress = new THREE.PlaneBufferGeometry(2, 0.38);
...
function headerSound(path) {
  ...
  hSoundOn.load(
    ...
    function (textureSound) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometrySound = new THREE.PlaneBufferGeometry(0.38, 0.38);
...
function headerHint() {
  ...
  hHint.load(
    ...
    function (textureHint) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometryHint = new THREE.PlaneBufferGeometry(0.38, 0.38);
...
function headerReward(RewardPath) {
  ...
  hReward.load(
    ...
    function (textureReward) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometryReward = new THREE.PlaneBufferGeometry(1, 0.38);
            ...
            if (planeGreenStatus == true) {
              ...
              loadS2RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_S2RHS_Ans = new THREE.PlaneBufferGeometry(3, 3);
            ...
            if (planeRedStatus == true) {
              ...
              loadS2LHS_Ans.load(
                ...
                function (textureLHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_S2LHS_Ans = new THREE.PlaneBufferGeometry(3, 3);
...
function l2Slide3() {
  ...
  loadS3LHS.load(
    ...
    function (textureS3LHS) {
      ...
      planeS3LHS = new THREE.Mesh(PG_LHS, PM_LHS);
            ...
            if (planeRedStatus == true) {
              ...
              loadS3LHS_Ans.load(
                ...
                function (textureLHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_LHS_Ans = new THREE.PlaneBufferGeometry(3, 3);
                  planeWrongAnsS3 = new THREE.Mesh(PG_LHS_Ans, PM_LHS_Ans);
                  if (S10Cor == false) {
  ...
  loadS3RHS.load(
    ...
    function (textureS3RHS) {
      ...
      planeS3RHS = new THREE.Mesh(PG_RHS, PM_RHS);
      ...
      if (AnsS3Cor == false) {
        ...
        domEvents.addEventListener(planeS3RHS, 'click', function (event) {
          if (AnsS3Cor == false) {
            ...
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS3RHS, 'click', function (event) {
            //     console.log("Remove Event lister S3 RHS")
            // })
            // // ----------------------------------------------------------------------
            ...
            if (planeGreenStatus == true) {
              ...
              loadS3RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_RHS_Ans = new THREE.PlaneBufferGeometry(3, 3);
                  planeCorrectAnsS3 = new THREE.Mesh(PG_RHS_Ans, PM_RHS_Ans);
                  if (S10Cor == false) {
      ...
      if (AnsS4Cor == false) {
        ...
        domEvents.addEventListener(planeS4LHS, 'click', function (event) {
          if (AnsS4Cor == false) {
            ...
            AnsS4Cor = true
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS4LHS, 'click', function (event) {
            //   console.log("Remove Event lister S4")
            // })
            // // ----------------------------------------------------------------------
      ...
      if (AnsS7Cor == false) {
        ...
        domEvents.addEventListener(planeS7LHS, 'click', function (event) {
          if (AnsS7Cor == false) {
            ...
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS7LHS, 'click', function (event) {
            //   console.log("Remove Event lister S7")
            // })
            // // ----------------------------------------------------------------------
      ...
      if (AnsS9Cor == false) {
        ...
        domEvents.addEventListener(planeS9LHS, 'click', function (event) {
          if (AnsS9Cor == false) {
            ...
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS9LHS, 'click', function (event) {
            //   console.log("Remove Event lister S9")
            // })
            // // ----------------------------------------------------------------------
      ...
      if (AnsS10Cor == false) {
        ...
        domEvents.addEventListener(planeS10LHS, 'click', function (event) {
          if (AnsS10Cor == false) {
            ...
            // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS10LHS, 'click', function (event) {
      ...
      if (AnsS10Cor == false) {
        ...
        domEvents.addEventListener(planeS10RHS, 'click', function (event) {
          if (AnsS10Cor == false) {
            ...
            // SCom = false
            // console.log("Red Light status in S10 onClick", planeWrongAns.visible);
            ErrorBorder = ""
            // SuccessBorder = ""

            // Remove Error Image From scene
            // scene.remove(planeWrongAns, planeWrongAnsS2, planeWrongAnsS3, planeWrongAnsS4, planeWrongAnsS5,
            ...
            // var allRHSPlane = planeS1RHS, planeS2RHS, planeS3RHS, planeS4RHS, planeS5RHS,
            //     planeS6RHS, planeS7RHS, planeS8RHS, planeS9RHS, planeS10RHS
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS10RHS, 'click', function (event) {
            //   console.log("Remove Event lister S10")
            // })
            // // ----------------------------------------------------------------------

            // // Remove Event For Red Error
            // // ----------------------------------------------------------------------
            // domEvents.removeEventListener(planeS10RHS, 'click', function (event) {
            //   console.log("Remove Event lister S10")
            //   // scene.remove()
            ...
            if (planeGreenStatus == true) {
              ...
              loadS10RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  // // Go to Level 1 Complete Function
                  // planeCorrectAnsS10.visible = false
                  // if (planeCorrectAnsS10.visible == false) {
                  //     planeCorrectAnsS10.visible = false
                  //     console.log("LOC Function works")
                  //     // setTimeout(L1Complete(), 2000)    // Working
                  //     // setTimeout(levelOneComplete(), 5000)    // Working
