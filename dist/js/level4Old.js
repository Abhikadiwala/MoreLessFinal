...
// Slide-2 Images
var S2LHS = "../asset/level_four_assets/image assest Lfour updated/Set 6_2 timers.png"  // 2 timers
var S2RHS = "../asset/level_four_assets/image assest Lfour updated/Set 6_6 timers.png"  // 6 timers

// Slide-3 Images
var S3LHS = "../asset/level_four_assets/image assest Lfour updated/Set 2_5 whistles.png"   // 5 whistles
var S3RHS = "../asset/level_four_assets/image assest Lfour updated/Set 2_2 whistles.png"   // 2 whistles

// Slide-4 Images
var S4LHS = "../asset/level_four_assets/image assest Lfour updated/Set 7_2 water bottles.png"  // 2 water bottles
var S4RHS = "../asset/level_four_assets/image assest Lfour updated/Set 7_4 water bottles.png"  // 4 water bottles

// Slide-5 Images
var S5LHS = "../asset/level_four_assets/image assest Lfour updated/Set 3_7 medals.png"   // 7 medals
var S5RHS = "../asset/level_four_assets/image assest Lfour updated/Set 3_5 medals.png"   // 5 medals
...
// Slide-8 Images
var S8LHS = "../asset/level_four_assets/image assest Lfour updated/Set 9_4 tomatoes.png"  // 5 tomatoes
var S8RHS = "../asset/level_four_assets/image assest Lfour updated/Set 9_6 tomatoes.png"  // 6 tomatoes

// Slide-9 Images                       
var S9LHS = "../asset/level_four_assets/image assest Lfour updated/Set 5_3 vests.png"  // 3 vests
var S9RHS = "../asset/level_four_assets/image assest Lfour updated/Set 5_4 vests.png"  // 4 vests
...
function headerProgress(PIpath) {
  ...
  hProgress.load(
    ...
    function (textureProgress) {
      ...
      //Create a 0.30x0.30 plane with texture
      var planeGeometryProgress = new THREE.PlaneBufferGeometry(1.70, 0.35);
            ...
            if (planeRedStatus == true) {
              ...
              loadS1LHS_Ans.load(
                ...
                function (textureS1LHS_Ans) {
                  ...
                  var PG_S1LHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
            ...
            if (planeGreenStatus == true) {
              ...
              loadS1RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  var PG_S1RHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
    ...
    function (textureS2LHS) {
      ...
      if (AnsS2Cor == false) {
        ...
        domEvents.addEventListener(planeS2LHS, 'click', function (event) {
          ...
          if (AnsS2Cor == false) {
            console.log("Correct Answer S2") // Select More Object
            AnsS2Cor = true
            S1Cor = false
            S2Cor = true
            ...
            isLHSCor = true
            // onClickAnswerCheck(S2L, S2R) //(Less, More)
            // onClickAnswerCheck(S2R, S2L) //(More, Less)
            // WrongAnswer()
            // CorrectAnswer()
            ...
            if (planeGreenStatus == true) {
              ...
              loadS2RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_S2RHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
                  // console.log("check for plaen size planeGeometryRHS", planeGeometryRHS)
                  // planeRHSMainGreen = new THREE.Mesh(planeGeometryRHS, planeMaterialRHS);
                  // planeCorrectAns = new THREE.Mesh(PG_S2RHS_Ans, PM_S2RHS_Ans);
      ...
      if (AnsS2Cor == false) {
        ...
        domEvents.addEventListener(planeS2RHS, 'click', function (event) {
          if (AnsS2Cor == false) {
            ...
            console.log("Wrong Answer S2")  // Less Object Image is Here
            isRHSWro = true
            // S2Wro = true
            ...
            if (planeRedStatus == true) {
              ...
              loadS3LHS_Ans.load(
                ...
                function (textureLHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_S3LHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
            ...
            if (planeGreenStatus == true) {
              ...
              loadS3RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_S3RHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
            ...
            if (planeRedStatus == true) {
              ...
              loadS4LHS_Ans.load(
                ...
                function (textureLHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_LHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
                  // console.log("check for plane size planeGeometryRHS", planeGeometryRHS)
            ...
            if (planeGreenStatus == true) {
              ...
              loadS4RHS_Ans.load(
                ...
                function (textureRHS_Ans) {
                  ...
                  //Create a 2x2 plane with texture
                  var PG_RHS_Ans = new THREE.PlaneBufferGeometry(3.6, 3.6);
