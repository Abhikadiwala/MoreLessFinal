...
// Use JS File Here
// import './Datastore'
import { sendToApp } from './event.js'
import { handleEvent } from './Datastore.js'

// console.log(" Data File Imported ", Data);


// var fetchSessionData = sessionStorage.getItem('data')
// console.log("All Session Data Fetch", fetchSessionData)
...
// window.onload = function () { document.getElementById("loading").style.display = "none", localStorage.setItem('timeSpentOnSite', 0) }
...
const canvas = document.querySelector('.level1Old');
...
// Full Screen is Active or Not Detections
...
// // ------------------------ Resize New Function ----------------------------------
// // Base camera
// // const aspect = window.innerWidth / window.i0nnerHeight;
...
//   // Update sizes
//   sizesnew.width = window.innerWidth
//   sizesnew.height = window.innerHeight

//   // Update camera
//   camera.aspect = sizesnew.width / sizesnew.height
//   camera.updateProjectionMatrix()

//   // Update renderer
//   renderer.setSize(sizesnew.width, sizesnew.height)
...
// var RewardStartImg = "../asset/logo/Rewards 0.png"   // Level 4 Start Reward // Active
...
// ----------   Load 2D Text --------------------------------------------
// var canv = document.createElement('canvas') // Active
// // var canv = document.querySelector('.level1Old');
// // canv.width = canv.height = 256;
// canv.width = canv.height = 70;
// var ctx = canv.getContext('2d')
// ctx.fillStyle = 'white';
// // ctx.fillStyle = transparent
// // ctx.fillStyle = "rgba(255, 255, 255, 0.1)";
// // ctx.fillRect(0, 0, canv.width, canv.height);
// ctx.fillRect(1, 1, canv.width, canv.height);
// ctx.fillStyle = 'black'
// // ctx.fillText("HERE IS SOME 2D TEXT", 20, 20);
// // ctx.fillText("HERE IS SOME 2D TEXT", 20, 20);
// // ctx.fillText("10 20 30", 20, 20);
// ctx.fillText("10", 20, 20);
...
// var plane = new THREE.Mesh(new THREE.PlaneGeometry(0.5, 0.5), mat);
// scene.add(plane)
// // plane.position.set(0, 0, 3)
// plane.position.set(3, 0.6, 2)
// -----------------------------------------------------------------------
...
//   var material = new THREE.MeshBasicMaterial({ color: 0xffffff, specular: 0xffffff });
...
//   // meshText.scale.multiplyScalar(0.009)
//   meshText.scale.x = 0.035
//   meshText.scale.y = 0.035
...
// This is the Function for Showing reward points after every completion
...
// loader.load('https://cdn.rawgit.com/mrdoob/three.js/master/examples/fonts/helvetiker_bold.typeface.json', function (font) {
...
// var textShapes = THREE.FontUtils.generateShapes('abhishek', 'helvetiker');
...
// var font;
// var loader = new THREE.FontLoader();
// loader.load('Abhishek', function (response) {
//   font = response;
// });
...
// const loader = new THREE.FontLoader();
// loader.load('https://threejs.org/examples/fonts/helvetiker_regular.typeface.json', function (THREE.Font) {
// const textgeo = new THREE.TextGeomerty('Abhishek', {
//   font: font,
//   size: 6,
//   height: 2,
...
//     const geometry = new THREE.TextGeometry(char.toString(), {
//       font: font,
//       // size: 1,
//       size: 10,
//       // height: 0.1
...
//     // console.log(font);
//     console.log("Text Load Function Working");
//     //   const char = arr[i];
//     //   // const char = numbershow;
...
//     //   // const geometry = new THREE.TextBufferGeometry(char.toString(), {
//     //   const geometry = new THREE.TextGeometry(font.toString(), {
//     //     font: font,
//     //     // size: 1,
//     //     size: 10,
//     //     // height: 0.1
...
//   // ======== storing the image in cache storage on first load ==========
//   // fetch(imageUrl).then((res) => {
//   fetch(WhiteBox).then((res) => {
//     // fetch(imageArray).then((res) => {
//     return caches.open(cacheName).then((cache) => {
//       // cache.put(imageUrl, res);
//       cache.put(WhiteBox, res);
//       // cache.put(imageArray, res);
//       // cache.add takes a bit more load than cache.put ********
//       //   cache.add(imageUrl);
//     });
//   });
...
//   //   "This browser doesn't support cache.";
...
//       })
//       // ----- if data is not found from cache it will load from the folder.
//       .catch(() => {
//         document
//           .getElementById("image")
//           // .setAttribute("src", "/assets/c.jpeg");
//           .setAttribute("src", WhiteBox);
//         // .setAttribute("src", imageArray);
//       });
//   });
// }
// loadFromCache()
...
function firstVisit() {
  ...
  loadImg.load(
    ...
    function (texture) {
      ...
      scene.add(plane);
      // interactionManager.add(plane);
      // plane.position.z = 1 // Active
      // plane.position.set(- width, height, 1); // top left
      plane.position.set(0, 0, 1) // Active
      // plane.position.set(-1, 1, 1) // test
      // plane.position.set(-(window.innerWidth) / 2, (window.innerHeight) / 2, 1)
      // plane.position.set(- width, height, 1); // top left
      // plane.position.set(- innerWidth, innerHeight, 1); // top left

      // var positionX = 100 * Math.sin(0.001)
      // var positionZ = 100 * Math.cos(0.001)
      // console.log("x", positionX, "y", positionZ);
      // plane.position.set(-positionX, 1, 1)
      // var axesHelper = new THREE.AxesHelper(3);
      // scene.add(axesHelper);
      // axesHelper.position.set(0, 0, 1)

      // plane.position.set(position.x + width / 2, position.y + height / 2)
      // plane.position.set(position.x + innerWidth / 2, position.y + innerHeight / 2)
      ...
      domEvents.addEventListener(plane, 'click', function (event) {
        // openFullscreen()
        // loadFromCache() // Store Data in Cache
        startCounting();
  ...
  loadS1LHS.load(
    ...
    function (textureS1LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        var intersects = raycaster.intersectObjects([planeS1LHS]);

        // console.log("Check layer of object 1", intersects[0].object);
        ...
        if (AnsS1Cor == false) {
          if (intersects.length > 0) {
            console.log("Click on Error Box 1")
            ...
            if (AnsS1Cor == false) {
              ...
              // planeS1LHS.removeEventListener(planeS1LHS,'click', false)
              // planeS1LHS.removeEventListener('click', false)
              AnsS1Cor = true
  ...
  loadS1RHS.load(
    ...
    function (textureS1RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects2 = raycaster.intersectObjects([planeS1RHS]);
        ...
        if (AnsS1Cor == false) {
          if (intersects2.length > 0) {
            console.log("Click on Correct Box 1")
            // intersects[0].object.material.color.setHex(Math.random() * 0xffffff);
            // const domEvents = new THREEx.DomEvents(camera, renderer.domElement);
            // domEvents.addEventListener(planeS1RHS, 'click', function (event) {
            if (AnsS1Cor == false) {
              AnsS1Cor = true
              // clearInterval(timer);  // Working
              ...
              setTimeout(() => {
                ...
                console.log("planeS1LHS Dispose", planeS1LHS);
                console.log("planeS1RHS Dispose", planeS1RHS);
                // scene.remove(PM_S1LHS, PG_S1LHS, planeS1LHS)            
                // console.log("PM_S1LHS Dispose", PM_S1LHS);
                // console.log("PM_S1LHS Dispose", PG_S1LHS);
  ...
  loadS2LHS.load(
    ...
    function (textureS2LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        // var intersects2 = raycaster.intersectObjects([planeS2LHS]);
        var intersects2 = raycaster.intersectObjects([planeS2LHS]);
        // console.log("Check layer of object 2", intersects2[0].object);
        // var layer2value = 1
        // camera.layers.set(layer2value)
        // console.log("set layer valye", camera.layers.set(layer2value));
        ...
        // And finally change the color:
        if (intersects2.length > 0) {
          console.log("Click on Error Box 2")
          // intersects[0].object.material.color.setHex(Math.random() * 0xffffff);
          if (AnsS2Cor == false) {
            // const domEvents = new THREEx.DomEvents(camera, renderer.domElement);
  ...
  loadS2RHS.load(
    ...
    function (textureS2RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects2 = raycaster.intersectObjects([planeS2RHS]);
        ...
        if (AnsS2Cor == false) {
          if (intersects2.length > 0) {
            console.log("Click on Correct Box 2")
            // intersects[0].object.material.color.setHex(Math.random() * 0xffffff);
            ...
            if (AnsS2Cor == false) {
              ...
              // setTimeout(() => {
              //   console.log("Before Material:", PM_S2RHS);
              //   console.log("Before Material uuid:", PM_S2RHS.uuid == undefined);
              //   // console.log("Test:", planeS2LHS.dispose());
              //   PM_S2RHS.dispose()
              //   scene.remove(PM_S2RHS)
              //   // renderer.render(scene, camera);
              //   // document.body.appendChild(renderer.domElement);
              //   // renderer.render()
              //   console.log("After Material:", PM_S2RHS);
              // }, 300);

              setTimeout(() => {
                // console.log("Before:", planeS2LHS);
                // // console.log("Test:", planeS2LHS.dispose());
                // planeS2LHS.PG_S2RHS.dispose()
                // console.log("After:", planeS2LHS);
              ...
              // console.log("planeS2rHS Dispose Before", planeS2RHS);
              // setTimeout(() => {

              //   scene.remove(planeS2LHS, planeS2RHS);
              //   planeS2RHS.PG_S2RHS.dispose();
              //   planeS2RHS.PM_S2RHS.dispose();
              //   planeS2RHS = undefined;
              //   console.log("planeS2rHS Dispose After", planeS2RHS);

              //   // console.log(planeS1LHS);
              //   AnsS3Cor = false
              // }, 1000);
  ...
  loadS3LHS.load(
    ...
    function (textureS3LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects3 = raycaster.intersectObjects([planeS3LHS]);
  ...
  loadS3RHS.load(
    ...
    function (textureS3RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects3 = raycaster.intersectObjects([planeS3RHS]);
  ...
  loadS4LHS.load(
    ...
    function (textureS4LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects4 = raycaster.intersectObjects([planeS4LHS]);
  ...
  loadS4RHS.load(
    ...
    function (textureS4RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects4 = raycaster.intersectObjects([planeS4RHS]);
  ...
  loadS5LHS.load(
    ...
    function (textureS5LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects5 = raycaster.intersectObjects([planeS5LHS]);
  ...
  loadS5RHS.load(
    ...
    function (textureS5RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects5 = raycaster.intersectObjects([planeS5RHS]);
  ...
  loadS6LHS.load(
    ...
    function (textureS6LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects6 = raycaster.intersectObjects([planeS6LHS]);
  ...
  loadS6RHS.load(
    ...
    function (textureS6RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects6 = raycaster.intersectObjects([planeS6RHS]);
  ...
  loadS7LHS.load(
    ...
    function (textureS7LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects7 = raycaster.intersectObjects([planeS7LHS]);
  ...
  loadS7RHS.load(
    ...
    function (textureS7RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects7 = raycaster.intersectObjects([planeS7RHS]);
  ...
  loadS8LHS.load(
    ...
    function (textureS8LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects8 = raycaster.intersectObjects([planeS8LHS]);
  ...
  loadS8RHS.load(
    ...
    function (textureS8RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects8 = raycaster.intersectObjects([planeS8RHS]);
  ...
  loadS9LHS.load(
    ...
    function (textureS9LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects9 = raycaster.intersectObjects([planeS9LHS]);
  ...
  loadS9RHS.load(
    ...
    function (textureS9RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects9 = raycaster.intersectObjects([planeS9RHS]);
  ...
  loadS10LHS.load(
    ...
    function (textureS10LHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects10 = raycaster.intersectObjects([planeS10LHS]);
  ...
  loadS10RHS.load(
    ...
    function (textureS10RHS) {
      ...
      function onDocumentMouseDown(event) {
        ...
        // And checking if it intersects with an array object
        // var intersects = raycaster.intersectObjects([cube]);
        var intersects10 = raycaster.intersectObjects([planeS10RHS]);
...
// Function Call After Level 1 Complete
// Level 1 Complete
...
// function demo() {
//   console.log("demo function working -------------------------");
// }
