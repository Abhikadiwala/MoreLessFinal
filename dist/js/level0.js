...
// Track force reload
// window.onbeforeunload = alert("page refresh action")
...
// ----------------------------------------------------------------
// var pageReload
// // Event listner for window click
// console.log("1st", pageReload)
// if (pageReload == true) {
//     console.log("2nd", pageReload)

//     pageReload = false
//     window.addEventListener('click', function () {
//         console.log("Click event working", pageReload)
//     });
// }
...
// Resize the Screen  - Global
// window.addEventListener('resize', Resize) -- active
//  ------------------------------------------------------------------------
...
document.addEventListener("visibilitychange", function () {
    ...
    if (pageHidden == true) {
        ...
        // window.location.reload() // Comment this for Temporory
    }
    if (pageHidden == false) {
        // sound.play()
        window.location.reload() // Comment this for Temporory
...
var speechBubble = 'asset/Speech_Bubble.png'
...
//Check Image Status
var musicImgStatus = true, planeSkipBtn, SoundImgpath
// var planeSkipBtn, SoundImgpath
...
// var BGSoundLocalStr = localStorage.setItem('BGSound', false)
var BGSoundLocalStr = localStorage.getItem('BGSound')
var BGSoundLocal = JSON.parse(BGSoundLocalStr)
// var musicImgStatus = JSON.parse(BGSoundLocalStr)
console.log("------------------------BG Statu", musicImgStatus);
...
//  ------------------------------------------------------------------------------------------------
// If User Comeback from other pages or like after some level don't show let's play btn
// fetch data from local storage
// localStorage.getItem
// console.log("Get Data------------------------------------------------");
// var setLevelStart = localStorage.setItem('levelStart', false);
var getLevelStartStr = localStorage.getItem('levelStart')
// console.log("Get Data------------------------------------------------", getLevelStartStr);
var getLevelStart = JSON.parse(getLevelStartStr)
// console.log("Get Data------------------------------------------------", getLevelStart);

if (getLevelStart == true) {
    console.log("Level 0 start");
    soundBG(bgSound)
    if (audioPlayed == true) {
        // checkBGAudio()
        setTimeout(() => {
    ...
    loadImg.load(
        ...
        function (texture) {
            ...
            domEvents.addEventListener(plane, 'click', function (event) {
                ...
                var setLevelStart = localStorage.setItem('levelStart', true);
            ...
            sound.source.onended = function () {
                ...
                switch (path) {
                    ...
                    case Audio1:
                        ...
                        // scene.remove(dot, dot2, dot3) // remove 3 dot before next instructor come
...
function headerSound(path) {
    // function headerSound(path, musicImgStatus) {
    ...
    hSoundOn.load(
        ...
        function (textureSound) {
            ...
            domEvents.addEventListener(planeSound, 'click', function (event) {
                ...
                // localStorage.setItem('BGSound', true)

                // toggelMusic(path, musicImgStatus) // active
                toggelMusic() // active

                // toggelMusicIcon()  // Testing

                // // ---------------------------------------------------------------------------------------------
                // console.log("1. BGSoundLocal True======", BGSoundLocal == true)
                // // console.log("BGSoundLocal False======", BGSoundLocal == false)

                // switch (BGSoundLocal == true) {
                //     case true:
                //         localStorage.setItem('BGSound', false)
                //         console.log("BGSound Active");
                ...
                //         const hSoundOff = new THREE.TextureLoader();
                //         hSoundOff.load(
                //             // Load Music Image
                ...
                //         );
                //         // ---------------------------------------------------------------------------------------------
                //         console.log("2. BGSoundLocal True======", BGSoundLocal == true)
                ...
                // var BGSoundLocalStr = localStorage.getItem('BGSound')
                // var BGSoundLocal = JSON.parse(BGSoundLocalStr)
                // console.log("------------------------BG Statu", BGSoundLocal);


                // // if (musicImgStatus == true) {// active
                // if (BGSoundLocal == false) {
                //     localStorage.setItem('BGSound', true)
                //     // console.log("Showing Mute btn");
                //     musicImgStatus = false
                //     sound2.pause()
                //     console.log("sound off");
                ...
                // else {
                //     localStorage.setItem('BGSound', false)
                //     // console.log("Showing Unmute btn");
                //     musicImgStatus = true
                //     sound2.play();
                //     console.log("sound on");
                //     const hSoundOn = new THREE.TextureLoader();
...
// Test Music btn from localstorage
// function toggelMusicIcon(path, musicImgStatus) {
function toggelMusicIcon() {
    console.log("toggelMusicIcon Function");

    // if (BGSoundLocal == true) {
    //     localStorage.setItem('BGSound', false)
    //     console.log("BGSound Active");
    ...
    console.log("BGSoundLocal True======", BGSoundLocal == true)
    // console.log("BGSoundLocal False======", BGSoundLocal == false)
...
// function toggelMusic(path, musicImgStatus) {
...
function dotAnimation() {
    ...
    if (isDotShow == true) {
        ...
        scene.add(dot);
        // dot.position.x = 0.9  // Active
        // dot.position.y = 0.27 // Active
        // dot.position.z = 1    // Active

        // dot.position.x = 0.77 // new
        // dot.position.y = 0.03 // new
        dot.position.x = dot1PosX
        dot.position.y = dot1PosY
        dot.position.z = 1
        ...
        scene.add(dot2);
        // dot2.position.x = 1.08 // Active
        // dot2.position.y = 0.27 // Active
        // dot2.position.z = 1    // Active
        // dot.scale.set(0, 0, 0);

        // dot2.position.x = 0.9 // new
        // dot2.position.y = 0.03 // new
        dot2.position.x = dot2PosX
        dot2.position.y = dot2PosY
        dot2.position.z = 1
        ...
        scene.add(dot3);
        // dot3.position.x = 1.25  // Active
        // dot3.position.y = 0.27  // Active
        // dot3.position.z = 1     // Active

        // dot3.position.x = 1.025 // new
        // dot3.position.y = 0.03 // new
        dot3.position.x = dot3PosX
        dot3.position.y = dot3PosY
        dot3.position.z = 1
...
function presentationOne() {
    ...
    loadInsL0_1.load(
        ...
        function (textureInsL0_1) {
            ...
            //Create a 2x2 plane with texture
            // var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(3, 3); // active
            // var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(2.3, 3); // badresh img - old
            var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(2.2, 2.7); // badresh img
            // var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(1.2, 2.5); // Kreedo Img -new
            ...
            planeInsL0_1.position.x = 0.5 // Active
            // planeInsL0_1.position.y = -0.8 // Active
            planeInsL0_1.position.y = -1 // Active
            // planeInsL0_1.position.z = 1

            // planeInsL0_1.position.x = 0 // Active -new
            // planeInsL0_1.position.y = -1.2 // Active - new
    ...
    // -----------------------------------------------------------------------------------------
    // const loadSpeechBubble = new THREE.TextureLoader();
    // loadSpeechBubble.load(
    //     speechBubble,
    //     // ins1,

    //     function (textureSpeech) {
    //         var planeMaterialSpeech = new THREE.MeshBasicMaterial({
    //             map: textureSpeech,
    //             transparent: true,
    //             // visible: false 
    //         });
    //         //Create a 2x2 plane with texture
    //         // var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(3, 3); // active
    //         // var planeGeometryInsL0_1 = new THREE.PlaneBufferGeometry(2.3, 3); // badresh img
    //         var planeGeometrySpeech = new THREE.PlaneBufferGeometry(1.5, 1); // Kreedo Img
    //         // var planeInsL0_1 = new THREE.Mesh(planeGeometryInsL0_1, planeMaterialInsL0_1);
    //         var planeSpeech = new THREE.Mesh(planeGeometrySpeech, planeMaterialSpeech);
    //         scene.add(planeSpeech);
    //         // planeInsL0_1.position.x = 0.5 // Active
    //         // planeInsL0_1.position.y = -0.8 // Active
    //         // // planeInsL0_1.position.z = 1

    //         planeSpeech.position.x = 1.2 // Active
    //         planeSpeech.position.y = 0.3 // Active

    //         // console.log("nextAudio status in One",nextAudio);
    //         if (nextAudio == true) {
    //             planeSpeech.visible = false
    //             // insTwoLoad = true;
    //             // presentationTwo();
    //         }
    //         nextAudio = false
...
function presentationTwo() {
    ...
    loadInsL0_2.load(
        ...
        function (textureInsL0_2) {
            ...
            //Create a 2x2 plane with texture
            // var planeGeometryInsL0_2 = new THREE.PlaneBufferGeometry(3, 3); // active
            // var planeGeometryInsL0_2 = new THREE.PlaneBufferGeometry(1.6, 2.7); // active -new
            var planeGeometryInsL0_2 = new THREE.PlaneBufferGeometry(2, 2.9); // active -new - final
            planeInsL0_2 = new THREE.Mesh(planeGeometryInsL0_2, planeMaterialInsL0_2);
            scene.add(planeInsL0_2);
            // planeInsL0_2.position.x = 2.3 // active
            // planeInsL0_2.position.y = -0.8 // active
            // // planeInsL0_2.position.z = 1

            planeInsL0_2.position.x = 3 // active - new
            // planeInsL0_2.position.y = -1.2 // active - new
            planeInsL0_2.position.y = -1 // active - new
    ...
    loadSkipbtn.load(
        ...
        function (textureSkipBtn) {
            ...
            domEvents.addEventListener(planeSkipBtn, 'click', function (event) {
                ...
                sessionStorage.setItem('skipClick', 0)
                ...
                if (level1_Pre_val == false) {
                    ...
                    // window.location.replace(`/level1_Pre.html`); // Working-old
                    // window.location.replace(`/skipBtnPage.html`); // Working
                    window.location.replace(`skipBtnPage.html`); // Testing

                } else {
                    // document.location.href = '/level2.html'
                    // window.location.replace(`/level1.html`); // Working
                    // window.location.replace(`/skipBtnPage.html`); // Working
                    window.location.replace(`skipBtnPage.html`); // Testing
...
function levelZeroComplete() {
    ...
    loadImg.load(
        ...
        function (texture) {
            ...
            // var planeGeometry = new THREE.PlaneBufferGeometry(1.2, 0.80); // Active - old
            // var planeGeometry = new THREE.PlaneBufferGeometry(0.9, 0.70); // active
            var planeGeometry = new THREE.PlaneBufferGeometry(0.9, 0.75);
            ...
            domEvents.addEventListener(planeLZCLHS, 'click', function (event) {
                ...
                //     location.href = '/index.html'
                // }
                // location.href = 'index.html' // path change
    ...
    introMoreloadRHS.load(
        ...
        function (textureintroMoreRHS) {
            ...
            // var planeGeometryintroMoreRHS = new THREE.PlaneBufferGeometry(0.9, 0.70); // active
            var planeGeometryintroMoreRHS = new THREE.PlaneBufferGeometry(0.9, 0.75); //
...
function init() {
    ...
    function NavBar() {
        ...
        // if (BGSoundLocal == false) {
        //     musicImgStatus = true
        //     SoundImgpath = MusicBtn
        // } else {
        //     musicImgStatus = false
        //     SoundImgpath = MusicMuteBtn
        // }
        // headerSound(SoundImgpath, musicImgStatus)
        // // headerSound(SoundImgpath)
